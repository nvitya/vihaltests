...
void board_pins_init()
{
  ...
  keymatrix.rowpin[0].Assign(PORTNUM_A, 0, false);
  keymatrix.rowpin[1].Assign(PORTNUM_A, 1, false);
  keymatrix.rowpin[2].Assign(PORTNUM_A, 2, false);
  keymatrix.rowpin[3].Assign(PORTNUM_A, 3, false);

  keymatrix.colpin[0].Assign(PORTNUM_A, 4, false);
  keymatrix.colpin[1].Assign(PORTNUM_A, 5, false);
  keymatrix.colpin[2].Assign(PORTNUM_A, 6, false);
  keymatrix.colpin[3].Assign(PORTNUM_A, 7, false);
}
