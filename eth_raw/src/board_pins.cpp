...
TGpioPin  pin_eth_reset(3, 4, false); // IOMUXC_GPIO_SD_B1_04_GPIO3_IO04
TGpioPin  pin_eth_irq(1,  10, false); // IOMUXC_GPIO_AD_B0_10_GPIO1_IO10
...
void board_pins_init()
{
  ...
  pin_eth_reset.Setup(PINCFG_OUTPUT | PINCFG_GPIO_INIT_0); // issue reset
  pin_eth_irq.Setup(PINCFG_INPUT | PINCFG_PULLUP); // pull up before reset
