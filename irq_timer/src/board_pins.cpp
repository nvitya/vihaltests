...
{
  SYSTIMER->MTIME64 = 0;  // restart the timer, this must be the very first line,
...
void board_pins_init()
{
  ...
  SYSTIMER->MTIMECMP64 = (SystemCoreClock / 4000);  // this timer counts every 4th system clock
  SYSTIMER->MTIME64 = 0;
  SYSTIMER->MTIMECTL = (0
