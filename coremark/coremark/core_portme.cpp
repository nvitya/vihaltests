...
/* Modified for the NVCM Library - by Viktor Nagy */
...
*/
#ifndef RUN_COREMARK
  #error "define RUN_COREMARK!"
#endif

static_assert(sizeof(ee_ptr_int) == sizeof(ee_u8 *), "ee_ptr_int definition error");
static_assert(sizeof(ee_u32) == 4, "Please define ee_u32 to a 32b unsigned type");
